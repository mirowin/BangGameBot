...
namespace BangGameBot
{
    static class Helpers
    {
        ...
        public static readonly List<CardDescription> Cards = new List<CardDescription>() {
            ...
            new CardDescription("AgADBAADu6kxGw_eSVPapbLPKgr4etXNvBkABFn5dE3XieMQmzwDAAEC", "Lucky Duke", Character.LuckyDuke, "Each time he is required to “draw!”, he flips the top two cards from the deck, and chooses the result he prefers. Discard both cards afterward."),
